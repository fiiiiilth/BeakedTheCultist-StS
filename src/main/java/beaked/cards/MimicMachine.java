...
public class MimicMachine extends CustomCard {
    public static final String ID = "beaked:MimicMachine";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractCard c;
        do {
            c = CardLibrary.getColorSpecificCard(AbstractPlayer.PlayerClass.DEFECT, AbstractDungeon.cardRandomRng).makeCopy();
