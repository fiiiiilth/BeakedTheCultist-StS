...
public class ShadowFade_DEPRECATED extends AbstractWitherCard {
    public static final String ID = "beaked:ShadowFade_DEPRECATED";
    ...
    public AbstractCard makeCopy() {
        return new ShadowFade_DEPRECATED();
    }
