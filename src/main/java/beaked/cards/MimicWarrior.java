...
public class MimicWarrior extends CustomCard {
    public static final String ID = "beaked:MimicWarrior";
    ...
    public void use(AbstractPlayer p, AbstractMonster m) {
        AbstractCard c;
        do {
            c = CardLibrary.getColorSpecificCard(AbstractPlayer.PlayerClass.IRONCLAD, AbstractDungeon.cardRandomRng).makeCopy();
